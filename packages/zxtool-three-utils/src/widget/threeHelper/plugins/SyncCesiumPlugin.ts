...
class SyncCesiumPlugin implements ThreeHelperPlugin {
  ...
  add(props: ThreeHelperPluginProps): void {
    ...
    animationCollection.set(this.ac_key, (time, delta) => {
      /*************** sync camera ***************/
      ...
      /*************** update renderer ***************/
      cache.updateRenderer?.(time, delta)
    })
...
export default SyncCesiumPlugin
